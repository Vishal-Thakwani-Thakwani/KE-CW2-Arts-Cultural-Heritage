...
sys.path.insert(0, str(Path(__file__).parent / "pipeline" / "structured"))
sys.path.insert(0, str(Path(__file__).parent / "pipeline" / "unstructured"))
...
if __name__ == "__main__":
    ...
    timed_step("Step 2a: Structured data ingestion", run_structured_data_workflow)
    timed_step("Step 2b: Unstructured data ingestion", run_unstructured_data_workflow)
